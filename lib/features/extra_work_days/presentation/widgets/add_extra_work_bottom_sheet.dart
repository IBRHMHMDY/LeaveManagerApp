...
class AddExtraWorkBottomSheet extends StatefulWidget {
  ...
  @override
  State<AddExtraWorkBottomSheet> createState() => _AddExtraWorkBottomSheetState();
}
              ...
              child: Row(
                ...
                children: [
                  Text(
                    ...
                    style: TextStyle(
                      fontSize: 16,
                      color: _selectedDate == null ? Colors.grey : colorScheme.onSurface,
                    ),
                  ),
                  const Icon(Icons.calendar_today, color: AppColors.restAllowanceColor),
                ],
              ),
            ),
          ),
